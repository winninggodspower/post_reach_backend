"""
Service layer for ContentPost mutations and lifecycle management.
Encapsulates all write/update/delete/dispatch business logic.
For queries and read access, use content.selectors.ContentPostSelector.
"""
...
class ContentPostService:
    """
    Stateless domain service for creating, updating, and deleting ContentPost records.
    ...
    def update_content_post(
        ...
        return ContentPostSelector.get_content_post(
            post_id=content_post.id, user=content_post.user
        )
